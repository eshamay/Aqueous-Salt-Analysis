...
def annotate_maxes (Xdata,Ydata,offset1,offset2):
	...
	Ydata_copy = Ydata_copy[1:500]
	y2, index2 = max((data, i) for i, data in enumerate(Ydata_copy))
...
annotate_gibbs(p0[2],p0[3],p0[0],p0[1],(60,45))
annotate_gibbs(p0[6],p0[7],p0[5],p0[4],(-180,45))

# label the max points for the ions in solution
annotate_maxes (x,NO3,(-80,10),(20,10))
annotate_maxes (x,NA,(-80,10),(20,10))

# print out a legend and axis labels
leg = ax.legend(('H2O', 'H2O tanh() Fit', 'CCl4', 'Na+ (x10 scale)', 'NO3- (x5 scale)'), 'best', shadow=True)
